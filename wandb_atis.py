...
# Trainning
parser.add_argument('--num_epoch', '-ne', type=int, default=150)
...
sweep_config = {
    ...
    "parameters": {
        ...
        "save_dir": {"values": ["./save/MixATIS_clean"]},
        "data_dir": {"values": ["./data/MixATIS_clean"]},
...
def train(config = None):
    ...
    import os
    wandb.init(config = None, name = nowtime,group = "atis")
    config = wandb.config
